...
| GameHasDiscardZone | boolean | false | If GameHasDiscardZone is set to true, a Discard Zone will be added to the Zones Viewer, where cards will be sent when removed from the play area. If GameHasDiscardZone is set to false, cards will simply deleted when removed from the play area. |
