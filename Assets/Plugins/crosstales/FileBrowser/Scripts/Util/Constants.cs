namespace Crosstales.FB.Util
{
    ...
    public abstract class Constants : Common.Util.BaseConstants
    {
        ...
        public const string ASSET_VERSION = "2020.1.0";

        /// <summary>Build number of the asset.</summary>
        public const int ASSET_BUILD = 20200110;
        ...
        public static readonly System.DateTime ASSET_CHANGED = new System.DateTime(2020, 1, 10);
