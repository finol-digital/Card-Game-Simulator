...
namespace GooglePlayServices {
    ...
    public class AndroidSdkManager {
        ...
        /// <summary>
        /// Dictionary definining the ANDROID_HOME environment variable.
        /// </summary>
        public static Dictionary<string, string> AndroidHomeEnvironment
        {
            get
            {
                return new Dictionary<string, string> { { AndroidHome, AndroidSdkRoot } };
            }
        }
