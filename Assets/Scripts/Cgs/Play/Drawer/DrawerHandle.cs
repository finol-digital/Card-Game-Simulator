...
namespace Cgs.Play.Drawer
{
    public class DrawerHandle : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler
    {
        ...
        public void OnDrag(PointerEventData eventData)
        {
            ...
            float minY = CardDrawer.HiddenPosition.y * CardGameManager.Instance.CardCanvas.transform.localScale.y;
            float y = Mathf.Clamp(targetY, minY, CardDrawer.ShownPosition.y);
